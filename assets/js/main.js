import { BuilderEnviroment } from "./builders/enviroment.js";//assets\js\builders\enviroment.js
...
export function build_enviroment () {
    ...
    var password = '';
    // BUILDER ROOM
    const build_enviroment = new BuilderEnviroment(username,password);
    build_enviroment.builder();
}

/* global AFRAME conf Cursor and Physics */
